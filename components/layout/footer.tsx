...
import { Car, Phone, Mail, MessageCircle, MapPin, Instagram, Facebook, Linkedin, Twitter, ChevronRight } from 'lucide-react';
    ...
    <footer className="relative border-t border-border bg-card/50">
      <div className="container-lux px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2.5 mb-4">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-gold-light via-gold to-gold-dark shadow-gold">
                <Car className="h-5 w-5 text-[hsl(var(--gold-foreground))]" />
              </div>
              <div className="leading-tight">
                <div className="font-display text-lg font-bold tracking-tight">Rentora Mobility</div>
                <div className="text-[10px] uppercase tracking-[0.2em] text-gold font-semibold">Premium Mobility. Trusted Journeys.</div>
              </div>
            </Link>
            ...
            <div className="flex gap-3 mt-6">
              {[Instagram, Facebook, Linkedin, Twitter].map((Icon, i) => (
                <a key={i} href="#" className="flex h-9 w-9 items-center justify-center rounded-full border border-border hover:border-gold/50 hover:text-gold transition-colors" aria-label="Social media">
        ...
        <div className="mt-12 pt-8 border-t border-border">
          <h4 className="text-xs uppercase tracking-wider text-muted-foreground mb-3">Popular Cities</h4>
