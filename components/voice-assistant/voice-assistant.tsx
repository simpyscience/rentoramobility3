...
All luxury cars come with professional chauffeurs. Available on request. Would you like to book?`;
  ...
  if (q.includes('corporate')) {
    return `We offer dedicated corporate rentals with monthly subscriptions, invoice billing, GST invoices and a dedicated account manager. Starting at ₹49,999/month. Email us at rentoramobility@protonmail.com for a custom corporate package.`;
  }
