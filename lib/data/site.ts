...
export const CITIES: City[] = [
  { slug: 'delhi', name: 'Delhi', state: 'NCR', image: 'https://images.pexels.com/photos/161901/delhi-india-161901.jpeg?auto=compress&cs=tinysrgb&w=800' },
  { slug: 'mumbai', name: 'Mumbai', state: 'Maharashtra', image: 'https://images.pexels.com/photos/3581368/pexels-photo-3581368.jpeg?auto=compress&cs=tinysrgb&w=800' },
  { slug: 'bangalore', name: 'Bangalore', state: 'Karnataka', image: 'https://images.pexels.com/photos/2901218/pexels-photo-2901218.jpeg?auto=compress&cs=tinysrgb&w=800' },
  { slug: 'jaipur', name: 'Jaipur', state: 'Rajasthan', image: 'https://images.pexels.com/photos/1558070/pexels-photo-1558070.jpeg?auto=compress&cs=tinysrgb&w=800' },
  { slug: 'udaipur', name: 'Udaipur', state: 'Rajasthan', image: 'https://images.pexels.com/photos/15400658/pexels-photo-15400658.jpeg?auto=compress&cs=tinysrgb&w=800' },
  { slug: 'goa', name: 'Goa', state: 'Goa', image: 'https://images.pexels.com/photos/9956391/pexels-photo-9956391.jpeg?auto=compress&cs=tinysrgb&w=800' },
  { slug: 'chandigarh', name: 'Chandigarh', state: 'Punjab', image: 'https://images.pexels.com/photos/16054303/pexels-photo-16054303.jpeg?auto=compress&cs=tinysrgb&w=800' },
  { slug: 'hyderabad', name: 'Hyderabad', state: 'Telangana', image: 'https://images.pexels.com/photos/14583750/pexels-photo-14583750.jpeg?auto=compress&cs=tinysrgb&w=800' },
  { slug: 'pune', name: 'Pune', state: 'Maharashtra', image: 'https://images.pexels.com/photos/2070703/pexels-photo-2070703.jpeg?auto=compress&cs=tinysrgb&w=800' },
  { slug: 'agra', name: 'Agra', state: 'Uttar Pradesh', image: 'https://images.pexels.com/photos/16045559/pexels-photo-16045559.jpeg?auto=compress&cs=tinysrgb&w=800' },
];

export const POPULAR_DESTINATIONS = [
  { slug: 'delhi-to-jaipur', from: 'Delhi', to: 'Jaipur', distance: '280 km', image: 'https://images.pexels.com/photos/1558070/pexels-photo-1558070.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'The royal Pink City journey' },
  { slug: 'delhi-to-agra', from: 'Delhi', to: 'Agra', distance: '230 km', image: 'https://images.pexels.com/photos/16045559/pexels-photo-16045559.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Visit the iconic Taj Mahal' },
  { slug: 'mumbai-to-pune', from: 'Mumbai', to: 'Pune', distance: '150 km', image: 'https://images.pexels.com/photos/2070703/pexels-photo-2070703.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Expressway weekend getaway' },
  { slug: 'bangalore-to-goa', from: 'Bangalore', to: 'Goa', distance: '560 km', image: 'https://images.pexels.com/photos/9956391/pexels-photo-9956391.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Beach road trip adventure' },
  { slug: 'delhi-to-udaipur', from: 'Delhi', to: 'Udaipur', distance: '670 km', image: 'https://images.pexels.com/photos/15400658/pexels-photo-15400658.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'City of Lakes retreat' },
  { slug: 'jaipur-to-udaipur', from: 'Jaipur', to: 'Udaipur', distance: '420 km', image: 'https://images.pexels.com/photos/15400658/pexels-photo-15400658.jpeg?auto=compress&cs=tinysrgb&w=800', description: 'Rajasthan royal trail' },
];
...
export const FAQS: FAQ[] = [
  ...
  },
  {
    ...
    a: 'Yes, we provide dedicated corporate rentals, monthly subscriptions, and long-term lease options for businesses. Contact us at rentoramobility@gmail.com or +91 9958021329 for custom corporate packages.',
  },
  {
